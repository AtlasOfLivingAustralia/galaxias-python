...
class IDwca(metaclass=ABCMeta):
    """Abstract Darwin Core Archive"""
    @abstractmethod
    def create_dwca(self, core_csv, ext_csv_list, output_dwca_path):
        """Create a DwCA

        :param core_csv: The core CSV file
        :param ext_csv_list: The list of extension CSV files
        :param output_dwca_path: The directory that contains the constructed DwCA
        """
        pass

    @abstractmethod
    def merge_dwca(self, other_dwca):
        """Merge this DwCA with another DwCA

        :param other_dwca: The DwCA to merge"""
        pass

    @abstractmethod
    def remove_extensions(self, exclude_ext_files, output_dwca_path):
        """remove extensions from this DwCA

        :param exclude_ext_files: The list of extension CSV files to remove
        :param output_dwca_path: The directory that contains the new DwCA
        """
        pass


class BaseDwca(IDwca):
    ...
    @abstractmethod
    def _set_keys(self, keys_lookup):
        pass
    ...
    @abstractmethod
    def _validate_content(self, error_file: str = None):
        pass
    ...
    def merge_dwca(self, delta_dwca: IDwca, output_dwca_path: str, keys_lookup: list[str] = [], extension_sync=False,
