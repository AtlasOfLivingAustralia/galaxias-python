...
from . import CsvFileType, IDwca, Dwca, LargeDwca
import logging
...
class BaseDwcaFactory(metaclass=ABCMeta):
    ...
    @abstractmethod
    def get_dwca(self) -> IDwca:
        """Get a Dwca for a data resource

        :param dr: The data resource identifier
        :return: The corresponding Dwca
        """
        pass

    @abstractmethod
    def get_dwca_from_dwca_file(self, dwca) -> IDwca:
...
class LargeDwcaFactory(BaseDwcaFactory):
    """Large Dwca factory which returns ALA-style collectory linked large wca instances backed by a work folder"""

    def get_dwca(self, work_dir, chunk_size) -> IDwca:
        """Get a large DwCA
    ...
    def get_dwca_from_dwca_file(self, dwca, work_dir, chunk_size) -> IDwca:
...
class DwcaFactoryManager:
    ...
    def get_dwca_from_csv(csv_file: list, use_chunking: bool = False, work_dir: str = './dwca/output/pickle',
                          chunk_size=50000, calculate_size: bool = True) -> BaseDwcaFactory:
    ...
    def get_dwca_from_dwca_file(dwca_file: str, use_chunking: bool = False, work_dir='./dwca/output/pickle',
                                chunk_size=50000, calculate_size: bool = False) -> BaseDwcaFactory:
...
class DwcaHandler:
    ...
    def remove_extension_files(dwca_file: str, ext_files: list, output_dwca_path: str = './dwca/output/'):
        ...
        dwca.remove_extensions(ext_files=ext_files, output_dwca_path=output_dwca_path)
    ...
    def sanitize_dwca(dwca_file: str, output_dwca_path: str, work_dir: str = './dwca/output/pickle',
        ...
        """Read a dwca an clean up any issues or mess
