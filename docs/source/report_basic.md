...
missing_columns: ['family', 'order', 'kingdom', 'phylum', 'genus', 'classs', 'basisOfRecord', 'occurrenceID OR catalogNumber OR recordNumber']
taxonomy_report: <dwc_validator.model.TaxonReport object at 0x118b03f90>
datetime_report: <dwc_validator.model.DateTimeReport object at 0x118b0e5d0>
incorrect_dwc_terms: []
