...
.. prompt:: python
    ...
    >>> emof = pd.read_csv("emof.csv")
    >>> my_dwca = galaxias.dwca(occurrences=occurrences,events=events,emof=emof)
    >>> my_dwca.generate_data_report()

.. program-output:: python -W ignore galaxias_user_guide/preparing_eventcore_script.py event_emof 1